  ...
  static ThemeData _buildLight() {
    ...
    return ThemeData(
      ...
      textTheme: AppTypography.textTheme.copyWith(
        displayLarge: AppTypography.textTheme.displayLarge?.copyWith(color: AppColors.textPrimaryLight),
        displayMedium: AppTypography.textTheme.displayMedium?.copyWith(color: AppColors.textPrimaryLight),
        displaySmall: AppTypography.textTheme.displaySmall?.copyWith(color: AppColors.textPrimaryLight),
        headlineLarge: AppTypography.textTheme.headlineLarge?.copyWith(color: AppColors.textPrimaryLight),
        headlineMedium: AppTypography.textTheme.headlineMedium?.copyWith(color: AppColors.textPrimaryLight),
        headlineSmall: AppTypography.textTheme.headlineSmall?.copyWith(color: AppColors.textPrimaryLight),
        titleLarge: AppTypography.textTheme.titleLarge?.copyWith(color: AppColors.textPrimaryLight),
        titleMedium: AppTypography.textTheme.titleMedium?.copyWith(color: AppColors.textPrimaryLight),
        titleSmall: AppTypography.textTheme.titleSmall?.copyWith(color: AppColors.textSecondaryLight),
        bodyLarge: AppTypography.textTheme.bodyLarge?.copyWith(color: AppColors.textPrimaryLight),
        bodyMedium: AppTypography.textTheme.bodyMedium?.copyWith(color: AppColors.textSecondaryLight),
        bodySmall: AppTypography.textTheme.bodySmall?.copyWith(color: AppColors.textMutedLight),
        labelLarge: AppTypography.textTheme.labelLarge?.copyWith(color: AppColors.textPrimaryLight),
        labelMedium: AppTypography.textTheme.labelMedium?.copyWith(color: AppColors.textSecondaryLight),
        labelSmall: AppTypography.textTheme.labelSmall?.copyWith(color: AppColors.textMutedLight),
      ),
      appBarTheme: AppBarTheme(
        backgroundColor: Colors.transparent,
        elevation: 0,
