...
class AppLocalizationsIt extends AppLocalizations {
  ...
  @override
  String get authWelcomeTitle => 'Benvenuto su KimiaCare';
  ...
  String get authBiometricSetupDesc =>
      'Sblocca KimiaCare con Face ID o la tua impronta digitale.';
  ...
  String get contactsPermissionSubtitle =>
      'KimiaCare ha bisogno del tuo permesso per visualizzare la tua rubrica.';
  ...
  String get callScreeningEnableDescription =>
      'Per bloccare le chiamate indesiderate, KimiaCare deve essere la tua app di filtraggio predefinita';
  ...
  @override
  String get iosFilteringStep2 => 'Attiva KimiaCare nell\'elenco';
  ...
  @override
  String get sosTriggerConfirmTitle => 'Inviare un\'allerta SOS?';

  @override
  String get sosTriggerConfirmMessage =>
      'Il tuo genitore sarà avvisato immediatamente con la tua posizione.';

  @override
  String get sosTriggerConfirmCancel => 'Annulla';

  @override
  String get sosTriggerConfirmSend => 'Invia SOS';

  @override
  String get sosSentSuccess => 'SOS inviato, il tuo genitore è stato avvisato';
  ...
  String get permissionLocationBody =>
      'KimiaCare ha bisogno della tua posizione per monitorare le zone';
  ...
  String get messagesIosLimitation =>
      'iOS: WhatsApp e Signal non possono essere intercettati da KimiaCare a causa del sandboxing Apple. Solo gli SMS sono filtrabili. Usa Screen Time per limitare WhatsApp su iOS.';
  ...
  String get messagesPermissionRequiredSubtitle =>
      'Attiva l\'accesso agli SMS per visualizzare i messaggi in KimiaCare';
  ...
  String get fitnessPermissionSubtitle =>
      'KimiaCare ha bisogno del permesso per contare i tuoi passi e monitorare l\'attività';
  ...
  @override
  String get sosContactsCall => 'Chiama';
  ...
  @override
  String get splashCtaButton => 'Entra in KimiaCare';
  ...
  String privacyIntro(String childName) {
    return 'Ai sensi del GDPR, puoi esportare o eliminare i dati di $childName in qualsiasi momento.';
  }

  @override
  String get privacyExportButton => 'Esporta i dati';

  @override
  String get privacyExportLoading => 'Esportazione in corso…';

  @override
  String privacyExportDescription(String childName) {
    return 'Scarica tutti i dati di $childName in formato JSON.';
  }
  ...
  @override
  String get privacyDeleteLoading => 'Eliminazione in corso…';

  @override
  String privacyDeleteDialogTitle(String childName) {
    return 'Dati di $childName';
  }

  @override
  String privacyDeleteDialogBody(String childName) {
    return 'Eliminare tutti i dati cancellerà la cronologia, le impostazioni e l\'abbinamento di $childName. Questa azione è irreversibile.\n\nValuta di esportare prima se vuoi conservare una copia.';
  }

  @override
  String get privacyDeleteExportFirst => 'Esporta prima';

  @override
  String get privacyDeleteConfirmDestructive => 'Elimina definitivamente';

  @override
  String get privacyDialogCancel => 'Annulla';

  @override
  String get privacyDeleteFinalTitle => 'Conferma finale';

  @override
  String privacyDeleteFinalBody(String childName) {
    return 'Stai per eliminare definitivamente tutti i dati di $childName. Anche l\'abbinamento sarà rimosso. Questa azione non può essere annullata.';
  }

  @override
  String get privacyDeleteFinalConfirm => 'Confermo';

  @override
  String privacyExportSuccessTitle(String childName) {
    return 'Esportazione di $childName salvata.';
  }

  @override
  String get privacyExportInternalStorageNote =>
      'Memoria interna — non visibile dal gestore file.';
  ...
  String privacyDeleteSuccess(String childName) {
    return 'Tutti i dati di $childName sono stati eliminati.';
  }
