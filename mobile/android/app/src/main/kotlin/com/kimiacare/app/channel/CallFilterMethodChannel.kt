package com.kimiacare.app.channel
...
import com.kimiacare.app.calls.BlockedCall
import com.kimiacare.app.calls.CallDecisionEngine
import com.kimiacare.app.calls.CallLogStore
import com.kimiacare.app.calls.CallRules
import com.kimiacare.app.calls.FilterMode
import io.flutter.plugin.common.MethodCall
import io.flutter.plugin.common.MethodChannel

/**
 * Pont Flutter ↔ Kotlin pour le filtrage d'appels.
 * Channel : "com.kimiacare.app/call_filter"
 */
class CallFilterMethodChannel(private val activity: Activity) :
    MethodChannel.MethodCallHandler {

    companion object {
        const val CHANNEL_NAME = "com.kimiacare.app/call_filter"
